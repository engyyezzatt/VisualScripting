...
class AllEdgeFunctions(Serializable):
    ...
    def __init__(self, scene:'Scene', start_socket:'Socket'=None, end_socket:'Socket'=None, edge_type=EDGE_TYPE_DIRECT):
        ...
        self.edge_type_chosen = edge_type
    ...
    def __str__(self):
        return "<Edge %s..%s -- S:%s E:%s>" % (hex(id(self))[2:5], hex(id(self))[-3:],
