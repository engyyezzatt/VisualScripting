...
from Nodeeditor.GraphicalEdge import DrawGraphicalEdge
from Nodeeditor.EdgeFunc import AllEdgeFunctions, EDGE_TYPE_CURVE
from Nodeeditor.GraphicalCutline import DrawGraphicalCutLine
...
class DrawGraphicalView(QGraphicsView):
    ...
    def leftMouseButtonPress(self, event):
        ...
        if type(item) is DrawGraphicalSocket:
    ...
    def edgeDragStart(self, item):
        ...
        self.drag_edge = AllEdgeFunctions(self.grScene.scene, item.socket, None, EDGE_TYPE_CURVE)
    ...
    def edgeDragEnd(self, item):
        ...
        if type(item) is DrawGraphicalSocket:
            if item.socket != self.drag_start_socket:
                ...
                new_edge = AllEdgeFunctions(self.grScene.scene, self.drag_start_socket, item.socket, edge_type=EDGE_TYPE_CURVE)
