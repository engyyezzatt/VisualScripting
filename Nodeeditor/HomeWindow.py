...
from Nodeeditor.HomeWidget import NodeEditorWidget
...
class NodeEditorWindow(QMainWindow):
    ...
    def changeTitle(self):
        ...
        if self.centralWidget().scene._has_been_modified:
            title += "*"
    ...
    def isModified(self):
        return self.centralWidget().scene._has_been_modified
